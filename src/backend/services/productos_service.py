...
def obtener_productos(id_categoria: str | None = None,
                      ...
                      direccion: str = "asc",
                      pagina: int = 1,
                      limite: int = 20) -> PaginatedResponse[Producto]:
    ...
    items = filtrados[inicio:inicio + limite]
...
def obtener_producto_por_id(id_producto: str) -> Producto:
    return repo_obtener_producto_por_id(id_producto)


def actualizar_producto(id_producto: str, datos: ProductoPatch) -> Producto:
    entidad = obtener_producto_por_id(id_producto)
    ...
    return repo_actualizar_producto(id_producto, entidad)
